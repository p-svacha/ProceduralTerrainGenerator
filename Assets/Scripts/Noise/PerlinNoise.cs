...
public static class PerlinNoise
{
    ...
    public static float[,] GenerateNoiseMap(int mapWidth, int mapHeight, RandomNumberGenerator rng, float scale, int octaves, float persistance, float lacunarity, Vector2 offset)
    {
